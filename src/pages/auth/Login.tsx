...
export const Login = () => {
  ...
  return (
    <>
      <SEO
        title="Sign In - FilmFrenzy"
        description="Sign in to your FilmFrenzy account to access your watchlist and continue streaming your favorite movies and TV shows."
      />
