...
export const SEO: React.FC<SEOProps> = ({
  ...
  const organizationSchema = {
    ...
    sameAs: [
      'https://facebook.com/filmfrenzy',
      'https://twitter.com/filmfrenzy',
      'https://instagram.com/filmfrenzy',
    ],
    contactPoint: {
      '@type': 'ContactPoint',
      contactType: 'customer support',
      email: 'contact@filmfrenzy.buzz'
    }
  };
  ...
  return (
    <Helmet>
      ...
      <meta name="twitter:site" content="@filmfrenzy" />
      <meta name="twitter:creator" content="@filmfrenzy" />
      ...
      {publishedAt && <meta property="article:author" content="FilmFrenzy" />}
